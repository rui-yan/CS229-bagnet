...
#---------------Load saved weights------------------------
checkpoint = torch.load("./saved_resnet.pth")
model_ft_resnet.load_state_dict(checkpoint['model_resnet_state_dict'])
optimizer_ft_resnet.load_state_dict(checkpoint['optimizer_resnet_state_dict'])
